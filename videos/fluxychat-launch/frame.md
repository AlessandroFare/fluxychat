...
description: >
  ...
  graph-paper grid, Geist serif 400 + Geist + DM Mono, the top/bottom cobalt
...
colors:
  ...
  ink: "#0E1316"
  ink-soft: "#C2410C"
  grid: "rgba(194, 65, 12, 0.10)"
  ink-faint: "rgba(194, 65, 12, 0.18)"
...
- **Geist 400** for all display (negative tracking); **Hanken 600** uppercase 0.16em labels; **DM Mono** chrome.
...
- **Geist at 400 only**, in cobalt, with negative tracking (hero −0.008em, numeral −0.015em). **Hanken labels uppercase, 0.16–0.18em.** **DM Mono 0.04–0.08em.** No bold serif.
...
- **Three Google Fonts** (Geist, Geist, DM Mono); CJK pairing (Noto Serif SC 700/400) carries over from the source.
