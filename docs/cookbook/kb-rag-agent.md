...
- [Custom tools](/docs/custom-tools) — expose `search_kb` as an agent tool instead of pre-prompt injection
- [Agent memory](/docs/agent-memory) — long-term customer context alongside KB
- [AI agents + handoff](/docs/handoff) — escalate to human when confidence is low
