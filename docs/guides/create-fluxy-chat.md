...
- [Adapter Pattern](./adapter-pattern.md) — How adapters work
- [Unified Chat API](./unified-chat-api.md) — Chat API for cross-platform operations
- [SDK README](../../packages/sdk/README.md) — Full SDK documentation
