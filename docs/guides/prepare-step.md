...
- [Lifecycle Callbacks](./lifecycle-callbacks.md) — events at each phase of the loop
- [Tool Approvals](./tool-approvals.md) — per-tool approval configuration
- [Provider Options](./provider-options.md) — provider-specific settings
