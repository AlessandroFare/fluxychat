...
const bubbleVariants = cva(
  "group/bubble relative flex w-fit max-w-[75%] min-w-0 flex-col gap-1 group-data-[align=end]/message:self-end data-[align=end]:self-end data-[variant=ghost]:max-w-full",
  {
    variants: {
      variant: {
        default: "",
...
const bubbleReactionsVariants = cva(
  "absolute z-10 flex w-fit shrink-0 items-center justify-center gap-1 rounded-full border border-[#e5e7eb] !bg-white px-2 py-0.5 text-[13px] text-slate-900 shadow-[0_1px_3px_rgba(0,0,0,0.1)] has-[button]:p-0 [&_button]:bg-transparent [&_button]:hover:bg-[#f1f5f9]",
  {
    variants: {
      side: {
        top: "top-0 -translate-y-1/2",
        bottom: "top-full -translate-y-[24%]",
      },
      align: {
        start: "left-3",
        end: "right-3",
