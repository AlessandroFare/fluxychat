...
/** Structured deep-research invoke text for agent rooms. */
...
/** Web search invoke text — instructs the agent to search for current information. */
...
/** Image generation caption posted alongside the generated attachment. */
