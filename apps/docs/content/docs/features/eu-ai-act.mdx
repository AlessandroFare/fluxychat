...
| **Project settings** | Provider identity, retention, disclosure & HITL enforcement toggles |
...
| **limited** | Customer support with disclosure | AI disclosure in system prompt + message metadata |
...
- [EU consent & DPA](/docs/features/eu-consent) — banner + audit log
...
5. Turn on **EU consent** + **data residency** if you have EU users.
6. Enable **moderation** + audit logging for customer-facing rooms.
7. Run **gap assessment** — resolve all critical/high items.
...
These remain **organizational / legal** obligations:
