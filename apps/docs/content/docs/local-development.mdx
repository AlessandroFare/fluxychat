...
description: "Everything you need to run FluxyChat locally â€” from fresh clone to sending your first message, testing agents, and debugging the dashboard onboarding flow."
---
...
For more troubleshooting, see [`docs/troubleshooting.md`](troubleshooting).
