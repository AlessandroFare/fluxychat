---
title: "FluxyChat — Feature Roadmap & Implementation Guide"
description: "> Consolidated technical roadmap (Aug 2026). Merges product research, zero-budget constraints, and **verified code inventory**."
---
...
> Companion docs: [ROADMAP.md](/docs/ROADMAP) (business/phases), [ROADMAP_REALTIME_FEATURES.md](/docs/ROADMAP_REALTIME_FEATURES) (AI SDK parity matrix), [COMPETITOR-PARITY-ROADMAP-2026.md](/docs/COMPETITOR-PARITY-ROADMAP-2026) (Sendbird/Stream/PubNub/Vercel gaps CP-001–CP-083), [NEXT-WAVE-ROADMAP-2026.md](/docs/NEXT-WAVE-ROADMAP-2026) (post-parity NW-100–NW-206), [CLOUDFLARE-AGENTS-VS-FLUXYCHAT-ROADMAP.md](/docs/CLOUDFLARE-AGENTS-VS-FLUXYCHAT-ROADMAP) (CF Agents SDK vs room kernel, CF-A-001–044).
...
**Workflow for every item:** research → align with [ROADMAP.md](/docs/ROADMAP) ADL → implement → test → docs → dashboard UI → landing if warranted.
...
| NW-110–114 | DX (CLI, Vue/Svelte, adapters, conformance, RN offline) | ⬜ | See [NEXT-WAVE-ROADMAP-2026.md](/docs/NEXT-WAVE-ROADMAP-2026) |
...
Full sprint order: [NEXT-WAVE-ROADMAP-2026.md](/docs/NEXT-WAVE-ROADMAP-2026).
...
See [ROADMAP_REALTIME_FEATURES.md](/docs/ROADMAP_REALTIME_FEATURES). Priority subset:
...
> | Document | Scope |
> |----------|-------|
> | [FLUXYCHAT-CROSS-ORG-AGENT-ROOMS-E-NUOVE-FEATURE.md](/docs/FLUXYCHAT-CROSS-ORG-AGENT-ROOMS-E-NUOVE-FEATURE) | Moonshot #32 + ambient agents, stages, passkeys, catch-up, consent |
> | [FLUXYCHAT-COUNTERFACTUAL-DEBATE-EMPATHY.md](/docs/FLUXYCHAT-COUNTERFACTUAL-DEBATE-EMPATHY) | #44 Counterfactual Replay, #45 Multi-Agent Debate, #46 Empathy Layer |
> | [FLUXYCHAT-ROOM-FIRMWARE-MERGE-SPECULATIVE.md](/docs/FLUXYCHAT-ROOM-FIRMWARE-MERGE-SPECULATIVE) | #47 Room Firmware, #48 Merge-Conflict UI, #49 Speculative Warmup |
> | [FLUXYCHAT-TRUTHMARKET-REHEARSAL-QUORUM-CARTOGRAPHY.md](/docs/FLUXYCHAT-TRUTHMARKET-REHEARSAL-QUORUM-CARTOGRAPHY) | #50–#53 Truth Market, Rehearsal, Quorum, Cartography |
...
| **Spec** | [FLUXYCHAT-CROSS-ORG-AGENT-ROOMS-E-NUOVE-FEATURE.md](/docs/FLUXYCHAT-CROSS-ORG-AGENT-ROOMS-E-NUOVE-FEATURE) §1 |
...
| **Doc** | [LOCAL_FIRST_SYNC_EVAL.md](/docs/LOCAL_FIRST_SYNC_EVAL) |
| **Priority** | ✅ Research |
...
| **Priority** | 🔴 Now |
| **Spec** | [FLUXYCHAT-TRUTHMARKET-REHEARSAL-QUORUM-CARTOGRAPHY.md](/docs/FLUXYCHAT-TRUTHMARKET-REHEARSAL-QUORUM-CARTOGRAPHY) §3 |
...
| **Effort** | 3–4 weeks |
| **Priority** | 🟡 Next |
| **Spec** | [FLUXYCHAT-CROSS-ORG-AGENT-ROOMS-E-NUOVE-FEATURE.md](/docs/FLUXYCHAT-CROSS-ORG-AGENT-ROOMS-E-NUOVE-FEATURE) §2.1 |
...
| **Priority** | 🟡 Next |
| **Spec** | [FLUXYCHAT-COUNTERFACTUAL-DEBATE-EMPATHY.md](/docs/FLUXYCHAT-COUNTERFACTUAL-DEBATE-EMPATHY) §1 |
...
| **Priority** | 🟡 Next |
| **Spec** | [FLUXYCHAT-COUNTERFACTUAL-DEBATE-EMPATHY.md](/docs/FLUXYCHAT-COUNTERFACTUAL-DEBATE-EMPATHY) §2 |
...
| **Priority** | ✅ MVP |
| **Spec** | [FLUXYCHAT-COUNTERFACTUAL-DEBATE-EMPATHY.md](/docs/FLUXYCHAT-COUNTERFACTUAL-DEBATE-EMPATHY) §3 |
...
| **Priority** | ✅ MVP |
| **Spec** | [FLUXYCHAT-ROOM-FIRMWARE-MERGE-SPECULATIVE.md](/docs/FLUXYCHAT-ROOM-FIRMWARE-MERGE-SPECULATIVE) §1 |
...
| **Priority** | 🟡 Next |
| **Spec** | [FLUXYCHAT-ROOM-FIRMWARE-MERGE-SPECULATIVE.md](/docs/FLUXYCHAT-ROOM-FIRMWARE-MERGE-SPECULATIVE) §2 |
...
| **Effort** | MVP shipped |
| **Priority** | 🟡 Next |
| **Spec** | [FLUXYCHAT-ROOM-FIRMWARE-MERGE-SPECULATIVE.md](/docs/FLUXYCHAT-ROOM-FIRMWARE-MERGE-SPECULATIVE) §3 |
...
| **Effort** | MVP shipped |
| **Priority** | ✅ MVP |
| **Spec** | [FLUXYCHAT-TRUTHMARKET-REHEARSAL-QUORUM-CARTOGRAPHY.md](/docs/FLUXYCHAT-TRUTHMARKET-REHEARSAL-QUORUM-CARTOGRAPHY) §1 |
...
| **Effort** | MVP shipped |
| **Priority** | 🟡 Next |
| **Spec** | [FLUXYCHAT-TRUTHMARKET-REHEARSAL-QUORUM-CARTOGRAPHY.md](/docs/FLUXYCHAT-TRUTHMARKET-REHEARSAL-QUORUM-CARTOGRAPHY) §2 |
...
| **Priority** | 🟡 Next |
| **Spec** | [FLUXYCHAT-TRUTHMARKET-REHEARSAL-QUORUM-CARTOGRAPHY.md](/docs/FLUXYCHAT-TRUTHMARKET-REHEARSAL-QUORUM-CARTOGRAPHY) §4 |
...
| **Effort** | MVP shipped |
| **Priority** | ✅ MVP |
| **Note** | Native Swift/Kotlin deferred; see PG-ZB-12 KMP in [ROADMAP.md](/docs/ROADMAP) |
...
| Document | Scope |
|----------|-------|
| [ROADMAP.md](/docs/ROADMAP) | Business phases, Portal gap, marketing |
| [ROADMAP_REALTIME_FEATURES.md](/docs/ROADMAP_REALTIME_FEATURES) | AI SDK parity, realtime audit |
| [docs/PORTAL-ZERO-BUDGET-ROADMAP.md](/docs/PORTAL-ZERO-BUDGET-ROADMAP) | Portal parity packaging |
| [docs/observability-otel.md](/docs/observability-otel) | Langfuse/Jaeger wiring |
| [docs/FLUXYCHAT-CROSS-ORG-AGENT-ROOMS-E-NUOVE-FEATURE.md](/docs/FLUXYCHAT-CROSS-ORG-AGENT-ROOMS-E-NUOVE-FEATURE) | Moonshot #32 + round-3 chat/AI specs |
| [docs/FLUXYCHAT-COUNTERFACTUAL-DEBATE-EMPATHY.md](/docs/FLUXYCHAT-COUNTERFACTUAL-DEBATE-EMPATHY) | #44–#46 differentiation UX |
| [docs/FLUXYCHAT-ROOM-FIRMWARE-MERGE-SPECULATIVE.md](/docs/FLUXYCHAT-ROOM-FIRMWARE-MERGE-SPECULATIVE) | #47–#49 speculative infra |
| [docs/FLUXYCHAT-TRUTHMARKET-REHEARSAL-QUORUM-CARTOGRAPHY.md](/docs/FLUXYCHAT-TRUTHMARKET-REHEARSAL-QUORUM-CARTOGRAPHY) | #50–#53 + #52 quorum detail |
