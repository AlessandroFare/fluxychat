---
title: "FluxyChat voice load-test report"
description: "> Run `./scripts/voice-load-test.sh` to regenerate this file with live numbers."
---
...
**Pending first run** — configure LiveKit (see [PRODUCTION-SETUP.md](/docs/PRODUCTION-SETUP)) then execute the script.
