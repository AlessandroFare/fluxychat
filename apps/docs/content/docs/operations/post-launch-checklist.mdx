...
**Goal:** Fill [VOICE-LOAD-TEST-REPORT.md](/docs/VOICE-LOAD-TEST-REPORT) with verifiable P90/P95, not estimates.
...
See: [MCP audit runbook in docs site](/docs/guides/ecosystem/mcp-audit-runbook) (apps/docs).
...
- [ ] `/get-started` mentions `npx create-fluxy-chat my-chat --minimal`
...
4. Update [feature parity checklist](/docs/guides/feature-parity-checklist): Mobile SDK → live
...
See [COMPETITIVE-STRATEGY.md](/docs/COMPETITIVE-STRATEGY).
