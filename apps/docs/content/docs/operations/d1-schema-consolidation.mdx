...
description: "FluxyChat currently ships **136 sequential migrations** under `apps/worker/db/` (0001â€“0136). P15â€“P20 added many feature-specific tables. This document defin"
---

# D1 schema consolidation plan (P21)

FluxyChat currently ships **136 sequential migrations** under `apps/worker/db/` (0001â€“0136). P15â€“P20 added many feature-specific tables. This document defines a **safe consolidation strategy** without blocking current deploys.
...
|--------|-------------------|--------|
| Core chat | 0001â€“0011, 0005, 0007 | messages, threads, reactions, tenancy |
| Agents & AI | 0010, 0013, 0060â€“0063, 0086 | agents, runs, memory, knowledge graph |
| Omnichannel | 0054â€“0057, 0079â€“0080 | telco, inbox, quiet hours |
| Enterprise | 0082, 0113â€“0117, 0129â€“0136 | retention, IP whitelist, eDiscovery, SSO |
| Integrations | 0124â€“0125, 0119 | bridges, marketplace |
| Ops | 0014â€“0016, 0105 | metrics, alerts, rate-limit dashboard |

## Recommended phases

### Phase 1 -- Inventory (done in repo)

- Keep applying migrations 0001â†’0136 on existing DBs (your deploy flow).
