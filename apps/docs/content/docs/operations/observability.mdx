...
description: "New projects receive seeded operational alert rules via `insertNewProject` → `seedDefaultAlertRules` (`apps/worker/src/lib/seed-default-alert-rules.js`)."
---
...
- Operator: `pnpm --filter @fluxy-chat/worker smoke:remote -- --base-url … --admin-jwt …`
