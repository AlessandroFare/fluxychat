...
- [Public demo hardening](/docs/public-demo-hardening) — Turnstile + origin allowlist for guest demos
- [In-app notifications](../../apps/worker/src/lib/in-app-notifications.js) — mention/DM rows in D1
- [Transport fallback](/docs/transport-fallback) — WS → SSE when mobile backgrounded
