---
title: "Transport fallback (WebSocket → SSE → polling)"
description: "`useChat` and `createFluxyRoomSession` automatically degrade transport when the room WebSocket cannot stay connected."
---
...
- [`packages/sdk/README.md`](/docs/../packages/sdk/README) — optimistic sends + `retryMessage`
