---
title: "Cookbook: Node bot that streams into a room"
description: "Use `FluxyMessageStream` from `@fluxy-chat/sdk` when your bot runs outside the Worker (Node script, Cloudflare Worker cron, etc.) but should publish the sam"
---
...
- [Assistant room use case](/docs/use-cases/assistant-room)
- [Dashboard integration](/docs/reference/dashboard-integration) — `useChat` replay modes
