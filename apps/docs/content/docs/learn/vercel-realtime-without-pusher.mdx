...
description: "Vercel excels at HTTP and SSR. Long-lived WebSocket rooms belong on Cloudflare Workers + Durable Objects. Keep your Next.js app on Vercel; run chat edge-native."
---
...
## Why "just add Pusher on Vercel" is the default
...
## Migration sketch (Pusher → FluxyChat)
...
## Build vs buy on the same stack
