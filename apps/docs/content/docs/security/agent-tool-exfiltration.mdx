---
title: "Agent runtime: tool_execute_url and data exfiltration"
description: "How FluxyChat agents call tenant-configured HTTP endpoints during a run, and what exfiltration risks operators should understand."
---
