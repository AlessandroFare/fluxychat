---
title: "Activepieces integration (CRM / automation)"
description: "Use **Activepieces** (MIT, self-hostable) to run no-code automations when FluxyChat events fire — sync to CRM, notify Slack, update Notion."
---
...
- [PRODUCTION-SETUP.md](/docs/operations/production-setup)
