---
title: "Kotlin Multiplatform mobile SDK"
description: "Shared WebSocket client for Android and iOS — same protocol as `@fluxy-chat/sdk`."
---
...
**Full setup (Sonatype, GPG, GitHub secrets):** [maven-central-publish.md](/docs/integrations/maven-central-publish)
...
- [maven-central-publish.md](/docs/integrations/maven-central-publish)
