---
title: "LiveKit integration (voice / video)"
description: "FluxyChat voice features use **LiveKit** as the WebRTC SFU. The Cloudflare Worker issues short-lived JWT access tokens; media runs on your LiveKit server, not o"
---
