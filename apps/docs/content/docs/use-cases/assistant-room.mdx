---
title: "Use case: Assistant room (AI agent)"
description: "Goal: a room where an AI agent can be invoked (manually or via mentions), with run history and cost visibility."
---
