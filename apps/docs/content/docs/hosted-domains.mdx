---
title: "Hosted domains: Cloudflare + Vercel + Worker API"
description: "Step-by-step reference for **`fluxychat.com`** (dashboard on Vercel) and **`api.fluxychat.com`** (Cloudflare Worker)."
---
