---
title: "Embeddable chat widget (P12-A)"
description: "One-line install for a support chat bubble on any website, powered by public guest sessions (P10-SB6) and optional custom domains (P12-G)."
---
