---
title: "Dashboard integration (JWT session & operator UI)"
description: "The Next.js app in `apps/dashboard` is a developer / operator console and live chat demo. This page summarizes how it authenticates and which Worker feature"
---
