---
title: "Webhook Secret Encryption Migration"
description: "This guide covers migrating existing plaintext webhook secrets to AES-GCM-encrypted values once `WEBHOOK_SECRET_ENCRYPTION_KEY` is configured."
---
