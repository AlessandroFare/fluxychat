...
description: "Route chat.yourcompany.com to a FluxyChat project on the Worker for embed widgets, guest chat, and branded API endpoints."
---

Route `https://chat.yourcompany.com` to a FluxyChat project on the Worker. Useful for embed widgets, guest chat, and branded API endpoints without exposing the platform `api.*` hostname.
...
- [Embeddable chat widget](/docs/reference/embed-widget)
- [Hosted domains (fluxychat.com setup)](/docs/reference/hosted-domains)
