---
title: "Observability — OpenTelemetry (self-host)"
description: "FluxyChat ships lightweight telemetry hooks in the SDK and Worker. Export to console for local dev, or OTLP HTTP for self-hosted backends — no SaaS requ"
---
