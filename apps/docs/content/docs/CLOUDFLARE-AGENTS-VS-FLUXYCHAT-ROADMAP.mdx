---
title: "Cloudflare Agents vs FluxyChat — competitive roadmap"
description: "> Date: 2026-08-25"
---

# Cloudflare Agents vs FluxyChat — competitive roadmap

> Date: 2026-08-25  
> Clone: `/docs (gitignored) = [cloudflare/agents](https://github.com/cloudflare/agents) `agents@0.21.0`, MIT  
> Online: Agents docs, Agents Week 2026, MCP 2026-07-28, SQLite DO mandate, AI Gateway unification, Sandbox / Browser Run  
> Companion: [FEATURE_ROADMAP.md](/docs/FEATURE_ROADMAP) · [ROADMAP.md](/docs/ROADMAP)
...
| **CF-A-024** | 🟡 | M | `vitest-pool-workers` for hibernation + schedule tests | Their CI bar | `apps/worker` |
| **CF-A-025** | 🟢 | L | Point-in-time recovery story for room SQL (30d PITR is platform) | Ops docs, not a feature flag | docs + runbook |
...
Later
  CF-A-016 025 032 033 044 polish
...
**Local clone:** `/docs — README, AGENTS.md, `packages/*`, `design/*`, examples list.  
