---
title: "Vertical platform expansion"
description: "Status: Living document — branch `fluxy` (July 2026)"
---
...
**Expansion layer detail:** [platform-expansion-layer.md](/docs/platform-expansion-layer)
...
- **Portal SDK** — competitive patterns adopted: [portal-sdk-comparison.md](//docs)
