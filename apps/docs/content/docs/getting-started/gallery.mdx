...
Health is not HIPAA. Stream WHIP/HLS needs Cloudflare Stream secrets; there is no gallery WHIP example yet. Voice numbers: [Voice load report](/docs/operations/voice-load-test-report).
