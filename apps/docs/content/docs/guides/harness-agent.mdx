...
- [Skill Uploads](/docs/skill-uploads) — uploading custom skills to providers
- [Subagents](/docs/subagents) — in-process agent delegation pattern
- [LLM Middleware](/docs/llm-middleware) — model-level interceptors
