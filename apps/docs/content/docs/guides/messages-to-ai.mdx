---
title: "Message-to-LLM Converter"
description: "`toAiMessages()` converts FluxyChat messages into the message format expected by AI SDKs (OpenAI, Anthropic, Vercel AI SDK, etc.)."
---
...
- [Provider Registry Guide](/docs/guides/provider-registry) — Managing AI providers
- [LLM Middleware Guide](/docs/guides/llm-middleware) — Transforming AI SDK calls
