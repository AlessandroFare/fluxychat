...
description: "FluxyChat's WorkflowAgent runs long-lived AI agents that survive deploys, restarts, and interruptions. State is persisted to D1/KV, so agents resume exactly where they left off."
---
...
- [Stream Resumption Guide](/docs/guides/stream-resumption) — Reconnecting to active AI streams
- [AI Tool Presets Guide](/docs/guides/ai-tool-presets) — Tool governance for workflow agents
