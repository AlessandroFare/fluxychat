...
See [Card Element Builder](/docs/card-builder) for all element types.
...
For approval gates that require human confirmation, combine cards with [AI tool presets](/docs/ai-tool-presets) so destructive actions pause until a moderator approves.
...
- [Card Element Builder](/docs/card-builder)
- [Adapter pattern](/docs/adapter-pattern) — platform-specific card rendering
- [Testing integrations](/docs/testing-integration) — mock client for Vitest
