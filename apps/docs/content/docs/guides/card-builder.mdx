...
- [Adapter Pattern Guide](/docs/guides/adapter-pattern) — How cards render per platform
- [AI Tool Presets Guide](/docs/guides/ai-tool-presets) — Approval gates for card interactions
