...
description: "FluxyChat's StreamingMarkdownRenderer buffers incoming text chunks and produces clean, incrementally rendered HTML, even when the markdown is incomplete mid-stream."
---

# Streaming Markdown Renderer

FluxyChat's `StreamingMarkdownRenderer` buffers incoming text chunks and produces clean, incrementally rendered HTML, even when the markdown is incomplete mid-stream.
...
- [Adapter Pattern Guide](/docs/guides/adapter-pattern) — Platform adapters and format conversion
- [Card Builder Guide](/docs/guides/card-builder) — Rich interactive message elements
