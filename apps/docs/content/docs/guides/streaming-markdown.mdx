...
- [Adapter Pattern Guide](/docs/adapter-pattern) — Platform adapters and format conversion
- [Card Builder Guide](/docs/card-builder) — Rich interactive message elements
