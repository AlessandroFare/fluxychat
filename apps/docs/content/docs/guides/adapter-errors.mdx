...
- [Unified Chat API](/docs/unified-chat-api) — Top-level chat methods
- [Adapter Lifecycle](/docs/adapter-lifecycle) — disconnect, postEphemeral, rehydrateAttachment, waitUntil
