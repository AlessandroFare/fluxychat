...
The adapter pattern abstracts platform-specific concerns behind a common `Adapter<TRawMessage>` interface. This lets you add new platforms without modifying core worker code.
