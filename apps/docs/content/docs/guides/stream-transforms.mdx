...
- [LLM Middleware](/docs/llm-middleware) — model-level transforms (before/after streaming)
- [Generating Text](/docs/reference/generation) — `generate()` and `stream()` functions
- [Stream Utils](/docs/reference/stream-utils) — `collectStreamParts`, `toTextStream`
