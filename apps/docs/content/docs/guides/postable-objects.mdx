...
description: "FluxyChat's PostableObject interface defines a contract for objects that can be passed to thread.post() and rendered by adapters, enabling third-party extensions."
---
...
- [Card Builder](/docs/guides/card-builder) — Built-in PostableObject for rich messages
- [Unified Chat API](/docs/guides/unified-chat-api) — Thread posting methods
- [Adapter Pattern](/docs/guides/adapter-pattern) — How adapters handle PostableObjects
