...
- Persist events on Worker/DO (see [vertical-platform-expansion.md](/docs/architecture/vertical-platform-expansion))
- Wire Yjs whiteboard per Architectural Decisions Log
- Connect SFU/TURN for live video

## Related

- [Vertical platform architecture](/docs/architecture/vertical-platform-expansion)
- [ROADMAP §5.3 FluxyEdu](/docs/../ROADMAP)
