...
- [Lifecycle Callbacks](/docs/guides/lifecycle-callbacks) — events at each phase of the loop
- [Tool Approvals](/docs/guides/tool-approvals) — per-tool approval configuration
- [Provider Options](/docs/guides/provider-options) — provider-specific settings
