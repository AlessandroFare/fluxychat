---
title: "Per-Thread Typed State"
description: "`createThreadState()` provides a typed state accessor per thread with merge/replace semantics and TTL — designed for multi-turn agent context."
---
