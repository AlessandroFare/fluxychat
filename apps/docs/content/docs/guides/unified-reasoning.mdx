...
description: "> Cross-provider reasoning control for AI generation. Configure how much \"thinking\" a model does before answering, with a portable API that works across OpenAI,"
---
