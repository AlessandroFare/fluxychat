...
- [Agent Loop Control](/docs/guides/loop-control) — step limits, stop conditions
- [Prune Messages](/docs/guides/prune-messages) — context compaction for parent
- [Memory](/docs/guides/memory) — persistent agent memory
