---
title: "Skill Uploads"
description: "Skill uploads let you upload custom skill bundles to AI providers. A skill is a set of files (e.g., a `SKILL.md` describing behavior) that providers load into s"
---
...
- [Provider Registry](/docs/guides/provider-registry) — combining providers
- [HarnessAgent](/docs/guides/harness-agent) — external agent runtime wrapper
