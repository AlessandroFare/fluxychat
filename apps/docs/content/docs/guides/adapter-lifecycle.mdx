---
title: "Adapter Lifecycle & Operations"
description: "FluxyChat adapter lifecycle methods provide hooks for cleanup, ephemeral messaging, attachment rehydration, and portable background task tracking."
---

# Adapter Lifecycle & Operations

FluxyChat adapter lifecycle methods provide hooks for cleanup, ephemeral messaging, attachment rehydration, and portable background task tracking.
...
- [Unified Chat API](/docs/guides/unified-chat-api) — `chat.thread()`, `chat.openDM()`, `chat.shutdown()`
- [Adapter Errors](/docs/guides/adapter-errors) — Error handling for adapter operations
- [Adapter Pattern](/docs/guides/adapter-pattern) — Core adapter interface
