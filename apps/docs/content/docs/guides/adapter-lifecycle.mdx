...
- [Unified Chat API](/docs/unified-chat-api) — `chat.thread()`, `chat.openDM()`, `chat.shutdown()`
- [Adapter Errors](/docs/adapter-errors) — Error handling for adapter operations
- [Adapter Pattern](/docs/adapter-pattern) — Core adapter interface
