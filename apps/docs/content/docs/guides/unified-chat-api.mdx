...
- [Adapter Errors](/docs/guides/adapter-errors) — Standardized error hierarchy for adapter operations
- [Chat Singleton](/docs/guides/chat-singleton) — Global singleton for thread deserialization
