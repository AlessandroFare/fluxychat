...
description: "FluxyChat's unified Chat API (P26-A) provides top-level methods that auto-infer the correct adapter from thread IDs and user IDs, so you can perform cross-platf"
---
