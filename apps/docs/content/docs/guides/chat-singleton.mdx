...
description: "FluxyChat's chat singleton provides a global registry so ThreadRef.fromJSON() can resolve adapters without passing a Chat instance through every call."
---
...
- [Unified Chat API](/docs/guides/unified-chat-api) — `chat.thread()`, `chat.openDM()`, `chat.getUser()`
- [Postable Objects](/docs/guides/postable-objects) — Objects that can be posted to threads
