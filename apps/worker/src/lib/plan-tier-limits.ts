...
export type PlanTierName = "free" | "starter" | "pro";
...
export const ALLOWED_PLAN_NAMES = new Set<PlanTierName>(["free", "starter", "pro"]);

export const CANONICAL_TIER_LIMITS: Readonly<Record<"starter" | "pro", TierLimits>> = Object.freeze({
