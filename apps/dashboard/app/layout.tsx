...
export default async function RootLayout({
  ...
  // Read the per-request CSP nonce generated by middleware.ts. Next.js
  // automatically forwards this nonce to all framework-injected <script>
  // and <style> tags it renders as part of RSC streaming + boot CSS.
